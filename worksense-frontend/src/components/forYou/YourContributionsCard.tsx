...
const YourContributionsCard: React.FC<YourContributionsCardProps> = ({
  assignedCount,
  completedCount,
  leaderboardData,
  userId,
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          >
            ...
            >
              {assignedCount > 0
                ? Math.round(
                    (completedCount / (assignedCount + completedCount)) * 100
                  )
                : 100}
              %
            </div>
            ...
            >
              <div
                style={{
                  height: "100%",
                  background:
                    "linear-gradient(90deg, var(--accent-pink), var(--accent-pink-hover))",
                  borderRadius: 4,
                  width: `${
                    assignedCount > 0
                      ? Math.round(
                          (completedCount / (assignedCount + completedCount)) *
                            100
                        )
                      : 100
                  }%`,
